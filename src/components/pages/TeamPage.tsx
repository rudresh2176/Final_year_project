...
const teamMembers = [
  {
    ...
    initials: 'BH',
    role: 'Testing & Docs',
    description: 'System testing, documentation, and quality assurance for the transformer monitoring project',
  },
  {
    name: 'PAVANKUMAR',
    usn: '1MS22EE037',
    initials: 'PK',
    role: 'ML & Analytics',
    description: 'Machine learning model training and abnormal conditions classification algorithms for fault detection and severity assessment',
  },
  {
    name: 'RUDRESH B S',
    usn: '1MS22EE042',
    initials: 'RB',
    role: 'Full-Stack Dev',
    description: 'Web dashboard development and Firebase real-time integration for data visualization and user interface',
  },
  {
    name: 'B.GIRISH',
    usn: '1MS22EE400',
    initials: 'BG',
    role: 'Hardware & IoT',
    description: 'Sensor integration, ESP32 programming, and hardware prototyping for real-time data acquisition from the transformer monitoring system',
  },
];
